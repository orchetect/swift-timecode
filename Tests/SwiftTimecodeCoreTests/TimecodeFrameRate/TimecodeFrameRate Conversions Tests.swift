...
@Suite
struct TimecodeFrameRate_Conversions_Tests {
    @Test(arguments: TimecodeFrameRate.allCases)
    func init_rate_allCases(frameRate: TimecodeFrameRate) {
    ...
    @Test(arguments: TimecodeFrameRate.allCases)
    func init_frameDuration_allCases(frameRate: TimecodeFrameRate) {
...
@Suite
struct TimecodeFrameRate_Conversions_CMTime_Tests {
    @Test
    ...
    @Test(arguments: TimecodeFrameRate.allCases)
    func frameDurationCMTime(frameRate: TimecodeFrameRate) throws {
