...
@Suite
struct Timecode_Rounding_Tests {
    // MARK: - Rounding Up

    @Test
    func roundedUp_days() throws {
        #expect(
    ...
    func roundedUp_hours() throws {
        ...
        #expect(
            try Timecode(.components(sf: 1), at: .fps24)
                .roundedUp(toNearest: .hours)
                .components
        ...
        #expect(
            try Timecode(.components(f: 1), at: .fps24)
                .roundedUp(toNearest: .hours)
                .components
                == Timecode.Components(h: 1)
        )
        ...
        #expect(
            try Timecode(.components(s: 1), at: .fps24)
                .roundedUp(toNearest: .hours)
                .components
                == Timecode.Components(h: 1)
        )
        ...
        #expect(
            try Timecode(.components(m: 1), at: .fps24)
                .roundedUp(toNearest: .hours)
                .components
                == Timecode.Components(h: 1)
        )
        ...
        #expect(
            try Timecode(.components(m: 1, s: 1, f: 1, sf: 1), at: .fps24)
                .roundedUp(toNearest: .hours)
                .components
                == Timecode.Components(h: 1)
        )
    ...
    func roundedUp_minutes() throws {
        ...
        #expect(
            try Timecode(.components(f: 1, sf: 1), at: .fps24)
                .roundedUp(toNearest: .minutes)
                .components
                == Timecode.Components(m: 1)
        )
        ...
        #expect(
            try Timecode(.components(s: 2, sf: 1), at: .fps24)
                .roundedUp(toNearest: .minutes)
                .components
                == Timecode.Components(m: 1)
        )
        ...
        #expect(
            try Timecode(.components(s: 2, f: 1), at: .fps24)
                .roundedUp(toNearest: .minutes)
                .components
                == Timecode.Components(m: 1)
        )
        ...
        #expect(
            try Timecode(.components(s: 2, f: 1, sf: 1), at: .fps24)
                .roundedUp(toNearest: .minutes)
                .components
                == Timecode.Components(m: 1)
        )
        ...
        #expect(
            try Timecode(.components(m: 1, sf: 1), at: .fps24)
                .roundedUp(toNearest: .minutes)
                .components
        ...
        #expect(
            try Timecode(.components(m: 1, f: 1), at: .fps24)
                .roundedUp(toNearest: .minutes)
                .components
                == Timecode.Components(m: 2)
        )
        ...
        #expect(
            try Timecode(.components(m: 1, s: 1), at: .fps24)
                .roundedUp(toNearest: .minutes)
                .components
                == Timecode.Components(m: 2)
        )
        ...
        #expect(
            try Timecode(.components(h: 1, m: 1), at: .fps24)
                .roundedUp(toNearest: .minutes)
                .components
        ...
        #expect(
            try Timecode(.components(h: 1, m: 1, f: 1), at: .fps24)
                .roundedUp(toNearest: .minutes)
                .components
    ...
    @Test
    func roundedUp_frames_EdgeCases() throws {
        #expect(
    ...
    @Test
    func roundedUp_subFrames() throws {
        // subFrames has no effect

        #expect(
            try Timecode(.zero, at: .fps24)
                .roundedUp(toNearest: .subFrames)
                .components
                == Timecode.Components()
        )
    ...
    @Test
    func roundedDown_minutes() throws {
        #expect(
            Timecode(.zero, at: .fps24)
    ...
    @Test
    func roundedDown_seconds() throws {
        #expect(
            Timecode(.zero, at: .fps24)
        ...
        #expect(
            try Timecode(.components(h: 1, s: 2, f: 1, sf: 1), at: .fps24)
                .roundedDown(toNearest: .seconds)
                .components
    ...
    @Test
    func roundedDown_frames() throws {
        #expect(
            Timecode(.zero, at: .fps23_976)
        ...
        #expect(
            try Timecode(.components(sf: 1), at: .fps23_976)
                .roundedDown(toNearest: .frames)
                .components
                == Timecode.Components()
        )
        ...
        #expect(
            try Timecode(.components(f: 1), at: .fps23_976)
                .roundedDown(toNearest: .frames)
                .components
                == Timecode.Components(f: 1)
        )
        ...
        #expect(
            try Timecode(.components(f: 1, sf: 1), at: .fps23_976)
                .roundedDown(toNearest: .frames)
                .components
                == Timecode.Components(f: 1)
        )
    ...
    @Test
    func roundedDown_subFrames() throws {
        // subFrames has no effect

        #expect(
            Timecode(.zero, at: .fps23_976)
                .roundedDown(toNearest: .subFrames)
                .components
                == Timecode.Components()
        )
