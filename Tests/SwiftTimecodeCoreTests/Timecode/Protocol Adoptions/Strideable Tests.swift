...
@Suite
struct Timecode_Strideable_Tests {
    @Test(arguments: TimecodeFrameRate.allCases)
    func advancedBy(frameRate: TimecodeFrameRate) throws {
    ...
    @Test(arguments: TimecodeFrameRate.allCases)
    func distanceTo_24Hours(frameRate: TimecodeFrameRate) throws {
    ...
    @Test(arguments: TimecodeFrameRate.allCases)
    func distanceTo_100Days(frameRate: TimecodeFrameRate) throws {
    ...
    @Test
    func timecode_Strideable_Ranges() throws {
        ...
        #expect(try !(
            Timecode(.string("01:00:00:00"), at: .fps23_976) ... Timecode(.string("01:00:00:06"), at: .fps23_976)
