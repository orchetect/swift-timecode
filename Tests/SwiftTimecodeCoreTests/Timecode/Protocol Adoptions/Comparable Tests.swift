...
@Suite
struct Timecode_Comparable_Tests {
    /// ==
    @Test
    func timecode_Equatable() throws {
        #expect(
    ...
    func timecode_Equatable(frameRate: TimecodeFrameRate) throws {
        #expect(
    ...
    /// < >
    @Test
    func timecode_Comparable() throws {
        #expect(try !(
            Timecode(.string("01:00:00:00"), at: .fps23_976) // false because they're ==
                < Timecode(.string("01:00:00:00"), at: .fps29_97)
        ))
        #expect(try !(
            Timecode(.string("01:00:00:00"), at: .fps23_976) // false because they're ==
    ...
    @Test(arguments: TimecodeFrameRate.allCases)
    func timecode_Comparable(frameRate: TimecodeFrameRate) throws {
        #expect(
            try Timecode(.string("01:00:00:00"), at: frameRate)
                < Timecode(.string("01:00:00:01"), at: frameRate)
        )
    ...
    @Test(arguments: TimecodeFrameRate.allCases)
    func timecode_Comparable_Sorted(frameRate: TimecodeFrameRate) throws {
    ...
    @Test(arguments: TimecodeFrameRate.allCases)
    func timecode_Sorted_1HourStart(frameRate: TimecodeFrameRate) throws {
    ...
    @Test(arguments: TimecodeFrameRate.allCases)
    func timecode_Sort_1HourStart(frameRate: TimecodeFrameRate) throws {
        let presorted: [Timecode] = try [
            Timecode(.string("01:00:00:00"), at: frameRate),
            Timecode(.string("02:00:00:00"), at: frameRate),
            Timecode(.string("03:00:00:00"), at: frameRate),
    ...
    @Test(arguments: TimecodeFrameRate.allCases)
    func timecode_Sorted_TimecodeSortComparator_1HourStart(frameRate: TimecodeFrameRate) throws {
        let presorted: [Timecode] = try [
            Timecode(.string("01:00:00:00"), at: frameRate),
            Timecode(.string("02:00:00:00"), at: frameRate),
            Timecode(.string("03:00:00:00"), at: frameRate),
