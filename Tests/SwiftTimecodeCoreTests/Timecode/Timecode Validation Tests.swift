...
@Suite
struct Timecode_Validation_Tests {
    @Test
    func validWithinRanges() {
    ...
    func subFrames(base: Timecode.SubFramesBase) {
        let fr = TimecodeFrameRate.fps24
        let limit = Timecode.UpperLimit.max24Hours
    ...
    func dropFrame(frameRate: TimecodeFrameRate) {
        let limit = Timecode.UpperLimit.max24Hours
    ...
    @Test
    func dropFrameEdgeCases() throws {
