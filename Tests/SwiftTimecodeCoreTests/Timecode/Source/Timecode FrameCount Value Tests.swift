...
@Suite
struct Timecode_Source_FrameCount_Value_Tests {
    @Test
    func timecode_init_FrameCountValue_Exactly() throws {
        let tc = try Timecode(
            .frames(670_907),
            at: .fps30,
            limit: .max24Hours
    ...
    @Test
    func timecode_init_FrameCountValue_Clamping() {
        let tc = Timecode(
    ...
    @Test
    func timecode_init_FrameCountValue_Wrapping() {
        let tc = Timecode(
            .frames(2_073_600 + 86400), // 25 hours @ 24fps
            at: .fps24,
            limit: .max24Hours,
    ...
    @Test
    func timecode_init_FrameCountValue_RawValues() {
        let tc = Timecode(
