...
@Suite
struct Timecode_Source_String_Tests {
    @Test(arguments: TimecodeFrameRate.allCases)
    func timecode_init_String_zero(frameRate: TimecodeFrameRate) throws {
        let tc = try Timecode(
            .string("00:00:00:00"),
            at: frameRate
        )
    ...
    @Test(arguments: TimecodeFrameRate.allCases)
    func timecode_init_String_nonZero(frameRate: TimecodeFrameRate) throws {
        let tc = try Timecode(
            .string("01:02:03:04"),
            at: frameRate
        )
    ...
    @Test
    func timecode_init_String_Clamping() throws {
        let tc = try Timecode(
            .string("25:00:00:00"),
            at: .fps24,
            by: .clamping
    ...
    @Test
    func timecode_init_String_ClampingEach() throws {
        let tc = try Timecode(
            .string("25:00:00:00"),
            at: .fps24,
    ...
    @Test(arguments: TimecodeFrameRate.allCases)
    func timecode_init_String_Wrapping(frameRate: TimecodeFrameRate) throws {
        let tc = try Timecode(
            .string("25:00:00:00"),
            at: frameRate,
            by: .wrapping
    ...
    @Test(arguments: TimecodeFrameRate.allCases)
    func timecode_init_String_RawValues(frameRate: TimecodeFrameRate) throws {
        let tc = try Timecode(
    ...
    @Test
    func stringValue_GetSet_Basic() throws {
        // basic getter tests
    ...
    func stringValue_Get_Formatting_Basic_24HourLimit_NonDrop(frameRate: TimecodeFrameRate) throws {
    ...
    func stringValue_Get_Formatting_Basic_24HourLimit_Drop(frameRate: TimecodeFrameRate) throws {
        // basic string formatting - ie: HH:MM:SS:FF
        // using known valid timecode components; not testing for invalid values here
    ...
    @Test(arguments: TimecodeFrameRate.allNonDrop)
    func stringValue_Get_Formatting_Basic_100DaysLimit_NonDrop(frameRate: TimecodeFrameRate) throws {
        // basic string formatting - ie: HH:MM:SS:FF
        // using known valid timecode components; not testing for invalid values here
    ...
    @Test(arguments: TimecodeFrameRate.allDrop)
    func stringValue_Get_Formatting_Basic_100DaysLimit_Drop(frameRate: TimecodeFrameRate) throws {
        // basic string formatting - ie: HH:MM:SS:FF
        // using known valid timecode components; not testing for invalid values here
    ...
    @Test(arguments: TimecodeFrameRate.allNonDrop)
    func stringValue_Get_Formatting_WithDays_24HoursLimit_NonDrop(frameRate: TimecodeFrameRate) throws {
    ...
    @Test(arguments: TimecodeFrameRate.allDrop)
    func stringValue_Get_Formatting_WithDays_24HoursLimit_Drop(frameRate: TimecodeFrameRate) throws {
        // string formatting with days - ie: "D HH:MM:SS:FF"
        // using known valid timecode components; not testing for invalid values here
    ...
    @Test(arguments: TimecodeFrameRate.allNonDrop)
    func stringValue_Get_Formatting_WithDays_100DaysLimit_NonDrop(frameRate: TimecodeFrameRate) throws {
        // string formatting with days - ie: "D HH:MM:SS:FF"
        // using known valid timecode components; not testing for invalid values here
    ...
    @Test(arguments: TimecodeFrameRate.allDrop)
    func stringValue_Get_Formatting_WithDays_100DaysLimit_Drop(frameRate: TimecodeFrameRate) throws {
        // string formatting with days - ie: "D HH:MM:SS:FF"
        // using known valid timecode components; not testing for invalid values here
    ...
    @Test(arguments: TimecodeFrameRate.allNonDrop)
    func stringValue_Get_Formatting_WithSubframes_24HoursLimit_NonDrop(frameRate: TimecodeFrameRate) throws {
    ...
    @Test(arguments: TimecodeFrameRate.allDrop)
    func stringValue_Get_Formatting_WithSubframes_24HoursLimit_Drop(frameRate: TimecodeFrameRate) throws {
        // string formatting with subframes - ie: "HH:MM:SS:FF.sf" (or "D HH:MM:SS:FF.sf" in case of 100 days limit)
        // using known valid timecode components; not testing for invalid values here
    ...
    @Test(arguments: TimecodeFrameRate.allNonDrop)
    func stringValue_Get_Formatting_WithSubframes_100DaysLimit_NonDrop(frameRate: TimecodeFrameRate) throws {
        // string formatting with subframes - ie: "HH:MM:SS:FF.sf" (or "D HH:MM:SS:FF.sf" in case of 100 days limit)
        // using known valid timecode components; not testing for invalid values here
    ...
    @Test(arguments: TimecodeFrameRate.allDrop)
    func stringValue_Get_Formatting_WithSubframes_100DaysLimit_Drop(frameRate: TimecodeFrameRate) throws {
        // string formatting with subframes - ie: "HH:MM:SS:FF.sf" (or "D HH:MM:SS:FF.sf" in case of 100 days limit)
        // using known valid timecode components; not testing for invalid values here
    ...
    @Test
    func stringValueVerbose() throws {
        var tc = Timecode(.zero, at: .fps23_976)
