...
@Suite
struct Timecode_Source_Samples_Tests {
    @Test(arguments: TimecodeFrameRate.allCases)
    func timecode_init_Samples_Exactly(frameRate: TimecodeFrameRate) throws {
        let tc = try Timecode(
    ...
    @Test(arguments: TimecodeFrameRate.allCases)
    func timecode_samplesGetSet_48KHz(frameRate: TimecodeFrameRate) throws {
    ...
    @Test
    func timecode_Samples_SubFrames() throws {
