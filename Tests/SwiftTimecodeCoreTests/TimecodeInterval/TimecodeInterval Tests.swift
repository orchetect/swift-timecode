...
struct TimecodeInterval_Tests {
    ...
    @Test
    func timecodeOffsettingA() throws {
        // positive
    ...
    /// Requires `@testable import`.
    @Test
    func timecodeOffsettingB() throws {
        // negative
    ...
    @Test
    func staticConstructors_Positive() throws {
    ...
    @Test
    func staticConstructors_Negative() throws {
