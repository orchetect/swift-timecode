...
@Suite
struct VideoFrameRate_Conversions_Tests {
    @Test
    func init_raw_nonStrict() {
    ...
    @Test
    func init_raw_invalid_nonStrict() {
    ...
    func init_rate_allCases(frameRate: VideoFrameRate) {
    ...
    @Test(arguments: VideoFrameRate.allCases)
    func init_frameDuration_allCases(frameRate: VideoFrameRate) {
    ...
    @Test
    func init_frameDuration_Typical() {
        // 24p
        #expect(
...
@Suite
struct VideoFrameRate_Conversions_CMTime_Tests {
    @Test
    func init_rate_CMTime() {
        #expect(
            VideoFrameRate(
    ...
    @Test
    func init_frameDuration_CMTime() {
        #expect(
            VideoFrameRate(
    ...
    @Test
    func frameDurationCMTime_SpotCheck() {
        #expect(
    ...
    @Test(arguments: VideoFrameRate.allCases)
    func frameDurationCMTime(frameRate: VideoFrameRate) throws {
