...
@MainActor @Suite
struct TimecodeField_View_Modifiers_Syntax_Tests {
    // MARK: - Test Constants

    @available(macOS 14.0, iOS 17.0, tvOS 17.0, watchOS 10.0, *)
    private var timecodeField: TimecodeField {
        TimecodeField(components: .constant(.zero))
    }

    private let isFoo = true

    @available(iOS 15.0, macOS 12.0, tvOS 15.0, watchOS 8.0, *)
    private var anyShapeStyle: any ShapeStyle {
        .tint
    }

    @available(iOS 15.0, macOS 12.0, tvOS 15.0, watchOS 8.0, *)
    private var anyOptionalShapeStyle: (any ShapeStyle)? {
        .tint
    }

    @available(iOS 15.0, macOS 12.0, tvOS 15.0, watchOS 8.0, *)
    private var concreteStyle: TintShapeStyle {
        .tint
    }

    @available(iOS 15.0, macOS 12.0, tvOS 15.0, watchOS 8.0, *)
    private var optionalConcreteStyle: TintShapeStyle? {
        .tint
    }
    ...
    @available(macOS 14.0, iOS 17.0, tvOS 17.0, watchOS 10.0, *)
    @Test
    func shapeStyleViewModifier_Baseline() {
    ...
    @available(macOS 14.0, iOS 17.0, tvOS 17.0, watchOS 10.0, *)
    @Test
    func viewModifier_timecodeField() {
        _ = timecodeField
    ...
    @available(macOS 14.0, iOS 17.0, tvOS 17.0, watchOS 10.0, *)
    @Test
    func viewModifier_timecodeFieldHighlightStyle() {
        // MARK: Basic
    ...
    @available(macOS 14.0, iOS 17.0, tvOS 17.0, watchOS 10.0, *)
    @Test
    func viewModifier_timecodeSeparatorStyle() {
        // MARK: Basic
    ...
    @available(macOS 14.0, iOS 17.0, tvOS 17.0, watchOS 10.0, *)
    @Test
    func viewModifier_timecodeSubFramesStyle_StyleOnly() {
        // MARK: Basic
    ...
    @available(macOS 14.0, iOS 17.0, tvOS 17.0, watchOS 10.0, *)
    @Test
    func viewModifier_timecodeSubFramesStyle_ScaleOnly() {
        _ = timecodeField
    ...
    @available(macOS 14.0, iOS 17.0, tvOS 17.0, watchOS 10.0, *)
    @Test
    func viewModifier_timecodeSubFramesStyle_StyleAndScale() {
        // MARK: Basic
    ...
    @available(macOS 14.0, iOS 17.0, tvOS 17.0, watchOS 10.0, *)
    @Test
    func viewModifier_timecodeValidationStyle() {
        // MARK: Basic
    ...
    @available(macOS 14.0, iOS 17.0, tvOS 17.0, watchOS 10.0, *)
    @Test
    func viewModifier_timecodeFieldInputRejectionFeedback() {
        _ = timecodeField
