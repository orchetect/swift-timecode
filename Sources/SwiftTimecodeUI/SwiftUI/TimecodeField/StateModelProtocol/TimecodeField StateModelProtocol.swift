...
extension TimecodeField._StateModelProtocol {
    ...
    public func handleKeyPress(
        ...
        case .deleteForward, // on full-size keyboard with numpad, this is the DEL key above the arrow keys.
                             // it can also be triggered by `Control+D` or `fn+Delete` key commands.
