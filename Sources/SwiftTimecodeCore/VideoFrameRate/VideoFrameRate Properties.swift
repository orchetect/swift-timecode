...
extension VideoFrameRate {
    ...
    public var rate: Fraction {
        ...
        case .fps119_88p: Fraction(120_000, 1001)
    ...
    public var frameDuration: Fraction {
        ...
        case .fps59_94i:  Fraction(2002, 120_000) // inferred
        ...
        case .fps119_88p: Fraction(1001, 120_000) // inferred
    ...
    public var alternateFrameDuration: Fraction? {
        ...
        case .fps59_94i:  Fraction(2000, 119_880) // inferred
        case .fps60p:     nil
        case .fps60i:     nil
        case .fps90p:     nil
        ...
        case .fps96p:     nil
        case .fps100p:    nil
        case .fps119_88p: Fraction(1000, 119_880)
        case .fps120p:    nil
        }
    }
